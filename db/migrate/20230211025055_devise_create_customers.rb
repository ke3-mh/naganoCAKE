...
class DeviseCreateCustomers < ActiveRecord::Migration[6.1]
  def change
    create_table :customers do |t|
      ...
      ## ----------- カラムを追加　開始 ----------
      t.string :last_name,          null: false, default: ""  # 性
      t.string :first_name,         null: false, default: ""  # 名
      t.string :last_name_kana,     null: false, default: ""  # 性カナ
      t.string :first_name_kana,    null: false, default: ""  # 名カナ
